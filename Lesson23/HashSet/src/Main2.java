...
public class Main2 {
    public static void main(String[] args) {
        ...
        //Задача 2: посчитать количество разных слов в тексте
        ...
        words = sentence.split(" "); //v massiv popadut vse slova predlozhenija
        int numberOfWord = words.length;
        System.out.println("Numbers of words in sentence is : " + numberOfWord);
